...
const Footer = () => {
  ...
  return (
    <footer>
      <div className="bg-[#03045E] py-4 ">
        <div className="container px-4 mx-auto">
          <div className="-mx-4 flex flex-wrap justify-between">
            <div className="px-4 my-4 w-full xl:w-1/5">
              <a to="/" className="block w-56 mb-10">
                <img src={logo} alt="" />
              </a>
              <p className="text-justify text-[20px] text-[#FFFFFF]">
                Ready to revolutionize
                your business communications with BlocBytes.
              </p>
              <button
            ...
            <div className="px-4 my-4 w-full sm:w-auto text-[#FFFFFF]">
              ...
              <p className="text-[14px]  text-[#00ADD3] leading-[13px] font-bold font inter uppercase">Address</p>
              <p className="mt-2 text-[17px] font-semibold leading-[27px] font-inter text-[#90E0EF]">HEAD OFFICE</p><p>
                12 S Atlantic Ave,
                Aberdeen
                Township, 07747</p>
              <p className="mt-4 flex  uppercase text-[#FFFFFF]  text-[11px]">
            ...
            <div className="px-4 my-4 w-full sm:w-auto text-[#FFFFFF]">
              <div>
                <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-600">Quick Links</h2>
              </div>
              <p className="text-[14px]  text-[#00ADD3] leading-[13px] font-bold font inter">BUSINESS</p>
              <ul className="leading-8 uppercase">
                ...
                <li><Link to="/term_and_condition" className="hover:text-blue-400">Term & Conditions</Link></li>
                <li><Link to="/cookie_policy" className="hover:text-blue-400">Cookie Policy</Link></li>
              </ul>
            </div>
            <div className="px-4 my-4 w-full sm:w-auto xl:w-1/5 text-[#FFFFFF]">
              <div>
      ...
      <div className="bg-[#03045E] py-4 text-gray-100">
        <div className="container mx-auto px-4">
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="px-4 w-full text-center sm:w-auto sm:text-left">
              Copyright © {currentYear > 2020 && ` - ${currentYear}`} Blocbytes. All Rights Reserved.
            </div>
          </div>
        </div>
      </div>
