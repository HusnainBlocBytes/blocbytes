  ...
  return (
    <div>
      <div className="py-6 flex items-center">
        <motion.span
          className="lg:px-16 font-inter text-[45px] font-medium text-[#03045E]"
      ...
      <motion.p
        className="lg:px-16 font-inter ml-4 text-[22px] font-normal text-[#03045E]"
      ...
      >
        Why Choose{" "}
        <span className="bg-[#90e0ef] text-[24px] text-[#03045E] px-2 ">
          Blocbytes
        </span>
      </motion.p>
      <motion.div
      ...
      >
        <p className="text-center font-medium font-inter text-[#03045E] leading-relaxed border border-[#90E0EF] rounded-[50%] max-w-4xl mx-auto p-8 sm:p-6 md:p-8 lg:px-28 lg:py-16 text-[14px] sm:text-[16px] md:text-[18px] lg:text-[20px]">
          ...
          <span className="bg-[#90e0ef] text-[#03045E] px-2 ">
            trust, innovation
          </span>{" "}
          and a{" "}
          <span className="bg-[#90e0ef] text-[#03045E] px-2 ">
          ...
          <span className="bg-[#90e0ef] text-[#03045E] px-2 py-1 ">
      ...
      <motion.div
        ...
        viewport={{ once: false, amount: 0.3 }}
      >
        <p className="lg:px-16 text-[24px] ml-4 leading-[32px] font-black font-inter text-[#03045E]">
          WHY US?
        </p>
      </motion.div>
      <motion.div
        className="flex flex-col lg:flex-row items-center lg:items-start mt-6 lg:px-16"
      ...
      >
        ...
        {/* Right side - Image */}
        <div className="mt-6 lg:mt-auto lg:ml-auto flex-shrink-0">
          <img
            src={Image1}
            alt="Description of image"
            className="max-w-full ml-2  h-auto object-contain  transition-transform transform hover:scale-105"
          />
        </div>
      </motion.div>
    </div>
