...
const Section5 = () => {
  return (
    <div
      className="relative bg-[#0B0F40] h-[350px] flex items-center justify-center bg-cover bg-center"
      style={{ backgroundImage: `url(${banner})` }}
    >
      {/* Foreground Text */}
      <h1 className="relative text-[40px] sm:text-[60px] md:text-[100px] lg:text-[150px] xl:text-[210px] text-[#7AB5FF] font-bold uppercase tracking-wide z-10">
        BlocBytes
      </h1>

      {/* Tag Bubbles */}
      <div className="z-20 space-x-4 flex flex-wrap justify-center">
