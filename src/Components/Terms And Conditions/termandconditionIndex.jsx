  ...
  return (
    <>
      ...
      >
        ...
        <p className=" font-[400] text-[16px] text-justify mt-4">
          ...
          <span className="  font-normal text-lg mt-4 2xl:ml-[0rem] xl:ml-[0rem]">
            <Link className="text-[#00add3] hover:text-[#03045E]" to="mailto:info@blocbytes.com">info@blocbytes.com</Link><br />
          </span>
        </p>
        <p className="font-[400] text-[16px] text-justify mt-4 ">
          Official
          ...
          <span className="font-normal text-lg mt-4 2xl:ml-[0rem] xl:ml-[0rem]">
            {" "}
            <Link className="text-[#00add3] hover:text-[#03045E]" to="tel:+18483458762">+18483458762</Link>
          </span>
        </p>
        <p className="font-[400] text-[16px] text-justify mt-4 ">
          WhatsApp
          ...
          <span className="font-normal text-lg mt-4 2xl:ml-[0rem] xl:ml-[0rem]">
            {" "}
            <Link className="text-[#00add3] hover:text-[#03045E]" to="https://wa.me/+18483458762">+18483458762</Link>
          </span>
        </p>
        <p className="font-[400] text-[16px] text-justify mt-4">
          Registered
          State:{" "}
          <span className="font-normal text-lg text-[#00add3] hover:text-[#03045E]">United States of America,  12 S Atlantic Ave, Aberdeen
            Township, 07747</span>
        </p>
        <h1 className="font-[695] text-[20px] text-start mt-4">
          Use of the Website
        ...
        <p className="text-lg text-justify mt-4 2xl:text-lg xl:text-lg lg:text-lg md:text-lg sm:text-lg ">
          ...
          us at <Link className="text-[#00add3] hover:text-[#03045E]" to="mailto:info@blocbytes.com">info@blocbytes.com</Link><br />
      ...
      <div className="block sm:hidden container mx-auto p-2 "
        style={{ fontFamily: "Aeonik Black Light" }}
      >
        <h1 className="font-[695] text-[32px] text-center mt-[7rem]">Terms And Conditions BlocBytes</h1>
        ...
        <p className="font-[400] text-[16px]  text-justify mt-2">
          Registered Name: <span className="font-[400] text-[16px]">BlocBytes</span>
        </p>
        <p className="font-[400] text-[16px] text-justify mt-2">
          Official Email: <span className="font-[400] text-[16px]">
            <Link className="text-[#00add3] hover:text-[#03045E]" to="mailto:info@blocbytes.com">info@blocbytes.com</Link>
          </span>
        </p>
        <p className="font-[400] text-[16px] text-justify mt-2">
          Official Number: <span className="font-[400] text-[16px]">
            <Link className="text-[#00add3] hover:text-[#03045E]" to="tel:+92 51 8990491">+18483458762</Link>
          </span>
        </p>
        <p className="font-[400] text-[16px] text-justify mt-2">
          Registered State: <span className="font-[400] text-[16px] text-[#00add3] hover:text-[#03045E]">United States of America,  12 S Atlantic Ave, Aberdeen
            Township, 07747</span>
        </p>
...
with these Terms shall be subject to the exclusive jurisdiction of the courts of USA.
        ...
        <h1 className="font-[695] text-[20px] text-start mt-8">Contact Information</h1>
        <p className="font-[400] text-[16px] text-justify mt-2">
        For any questions or concerns regarding these Terms and Conditions, please contact
          us at <Link className="text-[#00add3] hover:text-[#03045E]" to="mailto:info@blocbytes.com">info@blocbytes.com</Link><br />
          By using this Website, you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions.
